...
@class GKSectionHeaderView, GKGameRecommendationInternal, UICollectionReusableView, GKCollectionViewDataSource, GKCollectionViewAggregateDataSource, GKFriendPlayersDataSource, GKGameRecentPlayersDataSource, GKSegmentedSectionDataSource, GKSupplementaryViewMetrics, GKGameRecord, UIPopoverController, GKLeaderboardScoresDataSource, GKChallengesDataSource, GKAchievementsDataSource, NSArray;
