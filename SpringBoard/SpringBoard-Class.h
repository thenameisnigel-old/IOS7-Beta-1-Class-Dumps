/* SpringBoard-Class.h Was Dumped By @greensnow_tweak on Saturday, 15 June 2013 at 10:00:01 PM AEST On IOS 7 Beta 1 Firmware. */
/**
...
@class NSObject, UIWindow, BBDataProviderConnection, SBApplication, NSHashTable, NSTimer, NSMutableSet, NSSet, NSMutableArray, NSNumberFormatter, SBCardItemsController, NSDate, SBUIController;
...
-(void)updateWallpaperVisibilityAndBackdropStyle;
-(void)endRequiringWallpaperWithReason:(id)reason;
-(void)beginRequiringWallpaperWithReason:(id)reason;
