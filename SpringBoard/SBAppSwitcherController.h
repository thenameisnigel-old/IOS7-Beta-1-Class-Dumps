/* SBAppSwitcherController.h Was Dumped By @greensnow_tweak on Saturday, 15 June 2013 at 10:00:01 PM AEST On IOS 7 Beta 1 Firmware. */
/**
...
@class SBAppSwitcherBarView, SBAppSwitcherModel, NSString, SBNowPlayingBar, SBPrintStatusController;
...
-(id)view;
-(void)_lockScreenCameraWasOpened:(id)opened;
