/* SBIconController.h Was Dumped By @greensnow_tweak on Saturday, 15 June 2013 at 10:00:01 PM AEST On IOS 7 Beta 1 Firmware. */
/**
...
@class SBCloseBoxSettings, SBSearchGesture, NSTimer, SBRootFolderController, NSMutableSet, NSSet, NSMutableArray, SBIconModel, SBFolderSettings, BBObserver, NSObject, SBIconContentView, NSHashTable, UIImage, SBIcon, UITouch, SBFolder, SBLeafIcon;
@protocol OS_dispatch_queue;

__attribute__((visibility("hidden")))
@interface SBIconController : XXUnknownSuperclass <BBObserverDelegate, MCProfileConnectionObserver, SBApplicationRestrictionObserver, SBFolderControllerDelegate, _UISettingsKeyObserver, SBSearchGestureObserver, SBIconViewDelegate, SBIconModelDelegate, SBIconViewMapDelegate, SBIconModelApplicationDataSource> {
	NSSet* _visibleTags;
	NSSet* _hiddenTags;
...
@property(retain, nonatomic) UIImage* folderIconBackgroundImage;
@property(retain, nonatomic) UIImage* closeBoxImage;
@property(readonly, assign, nonatomic) SBSearchGesture* searchGesture;
+(id)sharedInstance;
-(void)searchGesture:(id)gesture changedOffset:(float)offset;
-(void)settings:(id)settings changedValueForKey:(id)key;
-(void)setAdaptiveColorInfo:(id)info;
-(void)_updateFolderBackgroundImageWithStatistics:(id)statistics;
-(void)_updateCloseBoxImageWithStatistics:(id)statistics;
-(float)_hueForColorStatistics:(id)colorStatistics;
-(id)_newFolderIconBackgroundImageWithSettings:(id)settings;
-(id)_newCloseBoxImageWithStatistics:(id)statistics;
-(void)removeFolderIconBackgroundObserver:(id)observer;
-(void)addFolderIconBackgroundObserver:(id)observer;
-(void)removeCloseBoxObserver:(id)observer;
-(void)addCloseBoxObserver:(id)observer;
...
-(void)_setGrabbedIcon:(id)icon forRelayout:(BOOL)relayout;
...
-(XXStruct_30PFcB)_statusBarOverridesForSnapshot;
