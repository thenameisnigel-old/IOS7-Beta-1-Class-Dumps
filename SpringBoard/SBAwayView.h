/* SBAwayView.h Was Dumped By @greensnow_tweak on Saturday, 15 June 2013 at 10:00:01 PM AEST On IOS 7 Beta 1 Firmware. */
/**
...
@class SBAwayViewPluginController, UIWindow, SBAwayInCallController, NSDictionary, SBAwaySwipeGestureRecognizer, SBAlertImageView, SBThermalLockoutView, UIView, SBAwayChargingView, NSMutableDictionary, NSTimer, SBAwayBuddyBackgroundView, SBAwayDateView, SBAwayLockBar, UIAlertView, SBAwayBulletinListController, TPLegacyBottomSingleButtonBar, UIButton;
...
@interface SBAwayView : SBSlidingAlertDisplay <SBAwayDateViewDelegate> {
	...
	CFBooleanRef _hasHardwareKeyboardCapability;
}
