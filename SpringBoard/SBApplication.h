/* SBApplication.h Was Dumped By @greensnow_tweak on Saturday, 15 June 2013 at 10:00:01 PM AEST On IOS 7 Beta 1 Firmware. */
/**
...
@class NSString, UIColor, NSTimer, NSMutableSet, NSSet, NSMapTable, NSMutableArray, NSDate, NSDictionary, BKSCFBundle, BKSMachSendRight, UIRemoteApplication, PCPersistentTimer, UILocalNotification, BKSProcessAssertion, BKSApplicationDataStore, NSHashTable, SBWindowContextManager, SBActivationContext, NSMutableDictionary, NSArray;
...
+(id)_orientationStringForOrientation:(int)orientation;
...
-(id)defaultImageForScreen:(id)screen snapshot:(BOOL*)snapshot originalOrientation:(int*)orientation currentOrientation:(int*)orientation4;
-(id)defaultImageForScreen:(id)screen;
...
-(void)_flushDefaultImageInfoForScreen:(id)screen;
...
-(id)_snapshotImageForScreen:(id)screen launchingOrientation:(int)orientation originalOrientation:(int*)orientation3 currentOrientation:(int*)orientation4;
