...
@class UINavigationBar, TUCall, NSArray, AudioDeviceController, TPLegacyBottomSingleButtonBar, TPLegacyBottomDoubleButtonBar, NSTimer, TPLegacyBottomBar, TPLegacyPhonePad, LegacyInCallLCDField, UITableView, UIAlertView, AddressBookController, TPLegacyAudioDeviceView, PhoneTabBarController, UIImage, LegacySixSquareView, LegacyInCallLCDView, LegacyPhoneDesktopView, UIView;
