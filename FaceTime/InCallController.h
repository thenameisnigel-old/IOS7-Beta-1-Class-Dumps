...
@class TPDialerNumberPad, UINavigationBar, TPBottomBar, TPAudioDeviceView, InCallLCDField, TUCall, NSArray, AudioDeviceController, NSTimer, UIAlertView, AddressBookController, PhoneTabBarController, InCallLCDView, SixSquareView, PHWallpaperView, ConferenceManagementTable, UIView, TPSuperBottomBar;
